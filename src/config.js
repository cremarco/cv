...
export const SECTION_CONFIG = {
  ...
  speaker_engagements: {
    ...
    subtitle: 'Scientific talks and invited presentations',
    sectionId: 'speaker-engagements',
    timelineId: 'speaker-engagements',
    cardType: 'speaker',
  ...
  thesis_supervisor: {
    ...
    cardType: 'thesis',
    previousSectionId: 'speaker-engagements',
  },
  awards: {
    title: 'Awards',
  ...
  submitted_publications: {
    ...
    sectionId: 'submitted-publications',
    timelineId: 'submitted-publications',
    cardType: 'publications',
  ...
  community_service: {
    ...
    previousSectionId: 'submitted-publications',
  },
...
export const SECTION_RENDER_PIPELINE = [
  ...
  { type: 'section', sectionKey: 'speaker_engagements' },
  ...
  { type: 'custom', loader: 'loadSubmittedPublications', dataKey: 'submitted_publications' },
